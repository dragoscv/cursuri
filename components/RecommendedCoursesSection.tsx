                  ...
                  <div className="mt-auto flex items-center justify-between gap-2">
                    ...
                    <div className="flex gap-2 ml-2">
                      ...
                      <button
                        ...
                        onClick={() =>
                          window.open(
                            `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.origin + '/courses/' + course.id)}`,
                            '_blank'
                          )
                        }
                      >
                      ...
                      <button
                        ...
                        onClick={() =>
                          window.open(
                            `https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.origin + '/courses/' + course.id)}&text=${encodeURIComponent('Check out this course: ' + course.name)}`,
                            '_blank'
                          )
                        }
                      >
                      ...
                      <button
                        ...
                        onClick={() =>
                          window.open(
                            `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(window.location.origin + '/courses/' + course.id)}`,
                            '_blank'
                          )
                        }
                      >
