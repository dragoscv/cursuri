  ...
  return (
    <div className="flex flex-row flex-wrap justify-between gap-2 p-2">
      <a
        ...
        aria-label="GitHub"
      >
        <GithubIcon className="text-[color:var(--ai-foreground)]" size={20} />
      </a>
      <a
        ...
        aria-label="Discord"
      >
        <DiscordIcon className="text-[color:var(--ai-foreground)]" size={20} />
      </a>
      <a
        ...
        aria-label="Website"
      >
        <WebsiteIcon className="text-[color:var(--ai-foreground)]" size={20} />
      </a>
      <a
        ...
        aria-label="TikTok"
      >
        <TikTokIcon className="text-[color:var(--ai-foreground)]" size={20} />
      </a>
      <a
      ...
      >
        <InstagramIcon className="text-[color:var(--ai-foreground)]" size={20} />
      </a>
    </div>
  );
}
