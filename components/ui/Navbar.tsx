 ...
 */
const NavbarBrand = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => {
...
const NavbarContent = forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & { justify?: 'start' | 'end' | 'center' }
>((props, ref) => {
  const { className = '', justify = 'start', ...rest } = props;
  // @ts-expect-error - HeroUI NavbarContent expects HTMLUListElement props but we use HTMLDivElement for flexibility
 ...
 */
const NavbarMenuToggle = forwardRef<
  HTMLButtonElement,
  React.ButtonHTMLAttributes<HTMLButtonElement>
>((props, ref) => {
  const { className = '', ...rest } = props;
  // @ts-expect-error - HeroUI NavbarMenuToggle has stricter value type than ButtonHTMLAttributes (library compatibility)
 ...
 */
const NavbarMenu = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => {
    const { className = '', ...rest } = props;
    ...
    // @ts-expect-error - HeroUI NavbarMenu expects HTMLUListElement props but we use HTMLDivElement for flexibility
 ...
 */
const NavbarMenuItem = forwardRef<HTMLLIElement, React.LiHTMLAttributes<HTMLLIElement>>(
  (props, ref) => {
    const { className = '', ...rest } = props;
