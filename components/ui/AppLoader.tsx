        ...
        <AnimatePresence>
            {!isComplete && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[9999] flex items-center justify-center bg-gradient-to-br from-[color:var(--ai-background)] via-[color:var(--ai-card-bg)] to-[color:var(--ai-background)]"
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-8">
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="text-sm font-medium text-[color:var(--ai-muted)]"
                            >
                                {Math.round(progress)}%
                            </motion.p>
                        </motion.div>
