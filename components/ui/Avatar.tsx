...
const Avatar = forwardRef<HTMLDivElement, AvatarProps>((props, ref) => {
    ...
    const onlineIndicatorClass = isOnline
        ? 'after:content-[""] after:absolute after:bottom-0 after:right-0 after:w-2.5 after:h-2.5 after:rounded-full after:bg-[color:var(--ai-success)] after:border-2 after:border-white dark:after:border-[color:var(--ai-card-bg)]'
        : '';
