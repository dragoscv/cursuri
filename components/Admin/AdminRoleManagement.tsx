...
import { UserRole, updateUserRole, getAdminUsers, hasPermission } from '../../utils/firebase/adminAuth';
                ...
                <Card>
                    ...
                    <CardBody>
                        <Table aria-label="Admin users table">
                            ...
                            <TableBody
                                isLoading={loading}
                                loadingContent="Loading admin users..."
                    ...
                    <ModalBody>
                        {selectedUser && (
                            <div className="space-y-4">
                                <div>
                                    <p><strong>User:</strong> {selectedUser.displayName || 'No name'}</p>
                                    <p><strong>Email:</strong> {selectedUser.email}</p>
                                    <p><strong>Current Role:</strong> {getRoleText(selectedUser.role)}</p>
                                </div>
                                <Select
                                    label="New Role"
                                ...
                                >
                                    <SelectItem key={UserRole.USER}>
                                        User
                                    </SelectItem>
                                    <SelectItem key={UserRole.ADMIN}>
                                        Admin
                                    </SelectItem>
                                    <SelectItem key={UserRole.SUPER_ADMIN}>
                                        Super Admin
                                    </SelectItem>
                                </Select>
                                ...
                                <div className="bg-warning-50 p-3 rounded-lg">
                                    <p className="text-sm text-warning-700">
                                        ...
                                        Make sure you understand the implications of this change.
                                    </p>
                                </div>
                            </div>
                        )}
