          ...
          {sortedLessons.map((lesson, index) => (
            ...
            >
              ...
              <td className="px-4 py-3">
                <span
                  className={`inline-block px-2 py-1 rounded text-xs font-semibold ${lesson.status === 'active' ? 'bg-[color:var(--ai-success)]/10 text-[color:var(--ai-success)]' : 'bg-[color:var(--ai-card-border)] text-[color:var(--ai-muted-foreground)]'}`}
                >
                  {lesson.status}
                </span>
              </td>
