...
export default function UserDetailView({ userId }: { userId: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs */}
      <Card className="shadow-md border border-[color:var(--ai-card-border)]">
        <CardBody className="p-0">
          <div className="border-b border-[color:var(--ai-card-border)] px-2">
            <Tabs
              ...
              variant="underlined"
              classNames={{
                tabList: 'gap-2 sm:gap-4 overflow-x-auto',
                tab: 'py-3 px-2 sm:px-3 font-medium whitespace-nowrap',
