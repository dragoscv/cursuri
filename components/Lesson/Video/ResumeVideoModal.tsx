    ...
    >
      <ModalContent>
        <ModalHeader className="flex flex-col gap-1">
          <h3 className="text-xl font-bold text-[color:var(--ai-foreground)]">{t('title')}</h3>
        </ModalHeader>
        <ModalBody>
          <div className="flex flex-col gap-4">
            <p className="text-[color:var(--ai-foreground)]">{t('message')}</p>
        ...
        <ModalFooter className="flex gap-2">
          <Button variant="bordered" onPress={onStartFromBeginning} className="flex-1 rounded-full">
            {t('startFromBeginning')}
          </Button>
          <Button
            color="primary"
            onPress={onResume}
            className="flex-1 bg-[color:var(--ai-foreground)] text-[color:var(--ai-background)] hover:opacity-90 rounded-full"
          >
            {t('resume')}
          </Button>
        </ModalFooter>
