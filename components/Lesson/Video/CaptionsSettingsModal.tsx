          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
              value === opt.value
                ...
                : 'bg-[color:var(--ai-card-bg)]/60 text-[color:var(--ai-foreground)] border border-[color:var(--ai-card-border)] hover:border-amber-500/40'
            }`}
          >
            {opt.label}
          </button>
...
const CaptionsSettingsModal: React.FC<Props> = ({
  isOpen,
  onClose,
  settings,
  onChange,
          ...
          <>
            <ModalHeader className="flex flex-col gap-1">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-amber-500 flex items-center justify-center text-[color:var(--ai-background)] text-xs font-bold">
                  CC
                </div>
            ...
            <ModalBody>
              ...
              <div
                ...
                style={{
                  aspectRatio: '16 / 9',
                  backgroundImage: 'linear-gradient(135deg, #1e293b 0%, #0f172a 50%, #312e81 100%)',
                }}
              >
                <div
