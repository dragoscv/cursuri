...
const QuestionsList: React.FC<QuestionsListProps> = ({ questions, lessonId, courseId, isLoading }) => {
        ...
        <div>
            <div className="mb-4">
                <Input
                    ...
                    className="w-full"
                    startContent={
                        <svg className="w-4 h-4 text-[color:var(--ai-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {filteredQuestions.length === 0 ? (
                <div className="text-center py-12 bg-[color:var(--ai-card-bg)]/30 border border-dashed border-[color:var(--ai-card-border)]/50 rounded-xl">
                    <svg className="w-10 h-10 text-[color:var(--ai-muted)]/60 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-[color:var(--ai-muted)]">
                        {searchQuery
                            ...
                            : filter !== 'all'
                                ? `No ${filter} questions for this lesson yet`
