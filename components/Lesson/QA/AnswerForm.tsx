                            ...
                            {attachment.type === 'image' ? (
                                <div className="relative">
                                    ...
                                    <Button
                                        ...
                                        className="absolute -top-2 -right-2 bg-[color:var(--ai-danger)] text-white rounded-full w-5 h-5 p-0 min-w-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
