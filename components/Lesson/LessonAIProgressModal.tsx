                ...
                <ModalHeader className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-[color:var(--ai-muted)] font-normal">
                        {isRunning
                            ...
                            : isDone
                                ? 'Audio, captions, transcript and summary have been saved on this lesson. Review and apply to the form, then click Update Lesson to keep your other edits.'
                                : isFailed
                                    ? 'The pipeline stopped. You can close this dialog and try again.'
                                    : ''}
                    </p>
                </ModalHeader>
