              ...
              <div className="space-y-4">
                ...
                <div>
                  <Button
                    ...
                    className="bg-[color:var(--ai-foreground)] text-[color:var(--ai-background)] border-none hover:opacity-90 transition-opacity rounded-full font-medium"
                    startContent={
                      <svg
                        width="18"
                        height="18"
                  ...
                  <div className="flex items-start gap-3 mb-3 w-full">
                    ...
                    <div className="flex-1 min-w-0 w-full">
                      ...
                      <div className="relative pl-3 mt-2">
                        <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-gradient-to-b from-amber-400/40 to-amber-500/40 rounded-full"></div>
                        <div className="pl-3 text-[color:var(--ai-muted)] text-sm leading-relaxed text-justify">
                          {review.htmlContent ? (
                            <div
                              dangerouslySetInnerHTML={{
                                __html: sanitizeModerate(review.htmlContent),
                              }}
                            />
                          ) : (
                            <p>{review.review}</p>
