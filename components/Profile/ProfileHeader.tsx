...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
    ...
    return (<div className="mb-6">
        <div className="bg-gradient-to-r from-[color:var(--ai-primary)]/10 via-[color:var(--ai-secondary)]/10 to-[color:var(--ai-accent)]/10 backdrop-blur-sm rounded-2xl p-5 md:p-7 border border-[color:var(--ai-card-border)] shadow-xl relative overflow-hidden">
