        ...
        <Navbar>
            ...
            <NavbarContent justify='end' as='div'>
                <Dropdown
                    ...
                    backdrop="blur"
                    classNames={{
                        base: "py-1 px-1 rounded-lg bg-gradient-to-br from-white to-default-200 dark:from-gray-300/90 dark:to-gray-200/70 z-50",
                        ...
                        content: "z-50 flex flex-col justify-start items-end",
                    }}
                    className="z-50"
                >
                    <DropdownTrigger>
                        <img src={user?.photoURL ? user?.photoURL : "https://i.pravatar.cc/150?u=a042581f4e29026704d"} alt="avatar" className="w-8 h-8 rounded-full border-2 border-violet-600 cursor-pointer" />
                    </DropdownTrigger>
                    <DropdownMenu
                            ...
                            >
                                ...
                                >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='currentColor' viewBox="0 0 20 20" version="1.1">
                                            ...
                                            <title>https://github.com/dragoscv</title>
