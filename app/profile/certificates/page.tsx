    ...
    return (
        <div className="space-y-6">            <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-2">
                <select
                    className="px-3 py-2 rounded-lg border border-[color:var(--ai-card-border)] bg-[color:var(--ai-card-bg)]/40 text-[color:var(--ai-foreground)] focus:outline-none focus:ring-2 focus:ring-[color:var(--ai-primary)]/20" onChange={(e) => {
                        const value = e.target.value;
                        if (value === 'all') {
                            setCertificates(allCertificates);
                        } else {
                            setCertificates(allCertificates.filter((cert: Certificate) => {
