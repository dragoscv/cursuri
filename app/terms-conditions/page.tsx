    ...
    return (
        <PolicyPage title={t('title')} lastUpdated={t('lastUpdated')}>
            ...
            <Section title={t('sections.accountRegistration.title')}>
                <Paragraph>
                    {t('sections.accountRegistration.content.registration')}
                </Paragraph>
                <Paragraph>
                    {t('sections.accountRegistration.content.responsibility')}
                </Paragraph>
            </Section>

            <Section title={t('sections.userConduct.title')}>
                <Paragraph>
                    {t('sections.userConduct.intro')}
                </Paragraph>
                <List items={[
            ...
            <Section title={t('sections.intellectualProperty.title')}>
                <Paragraph>
                    {t('sections.intellectualProperty.content.ownership')}
                </Paragraph>
                <Paragraph>
                    {t('sections.intellectualProperty.content.license')}
                </Paragraph>
            </Section>
            ...
            <Section title={t('sections.coursesAndSubscriptions.title')}>
                <Subsection title={t('sections.coursesAndSubscriptions.courseAccess.title')}>
                    <Paragraph>
                        {t('sections.coursesAndSubscriptions.courseAccess.content')}
                    </Paragraph>
                </Subsection>

                <Subsection title={t('sections.coursesAndSubscriptions.paymentsAndRefunds.title')}>
                    <Paragraph>
                        {t('sections.coursesAndSubscriptions.paymentsAndRefunds.content')}
                    </Paragraph>
                </Subsection>

                <Subsection title={t('sections.coursesAndSubscriptions.courseUpdates.title')}>
                    <Paragraph>
                        {t('sections.coursesAndSubscriptions.courseUpdates.content')}
                    </Paragraph>
                </Subsection>
            </Section>
            ...
            <Section title={t('sections.userGeneratedContent.title')}>
                <Paragraph>
                    {t('sections.userGeneratedContent.content.grant')}
                </Paragraph>
                <Paragraph>
                    {t('sections.userGeneratedContent.content.warranty')}
                </Paragraph>
            </Section>
            ...
            <Section title={t('sections.disclaimerOfWarranties.title')}>
                <Paragraph>
                    {t('sections.disclaimerOfWarranties.content.asIs')}
                </Paragraph>
                <Paragraph>
                    {t('sections.disclaimerOfWarranties.content.noGuarantee')}
                </Paragraph>
            </Section>
            ...
            <Section title={t('sections.termination.title')}>
                <Paragraph>
                    {t('sections.termination.content.right')}
                </Paragraph>
                <Paragraph>
                    {t('sections.termination.content.effect')}
                </Paragraph>
            </Section>
