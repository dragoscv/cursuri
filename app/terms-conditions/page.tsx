            ...
            <Card className="p-6">
                <CardBody>
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                        <p className="text-sm text-gray-500 mb-6">Last updated: April 4, 2025</p>
                        ...
                        <ul className="list-disc pl-6 mb-4">
                            <li><strong>"Platform"</strong> refers to the Cursuri website and all its contents, features, and services.</li>
                            <li><strong>"User," "You," and "Your"</strong> refer to the individual or entity accessing or using the Platform.</li>
                            <li><strong>"We," "Us," and "Our"</strong> refer to Cursuri.</li>
                            <li><strong>"Content"</strong> refers to course materials, videos, text, graphics, images, and other materials available on the Platform.</li>
                            <li><strong>"Subscription"</strong> refers to the paid access to courses or services offered on the Platform.</li>
                        </ul>
                        ...
                        <h2 className="text-2xl font-semibold mt-8 mb-4">6. Courses and Subscriptions</h2>
                        <h3 className="text-xl font-medium mt-6 mb-2">Course Access</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-medium mt-6 mb-2">Payments and Refunds</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-medium mt-6 mb-2">Course Updates</h3>
                        <p>
