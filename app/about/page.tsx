  ...
  return (
    <div className="min-h-screen bg-[color:var(--ai-background)] pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mission Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-[color:var(--ai-foreground)] mb-6">
            {t('mission.title')}
          </h2>
        ...
        {/* What We Offer */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-[color:var(--ai-foreground)] mb-8">
            {t('whatWeOffer.title')}
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[color:var(--ai-card-bg)] border border-[color:var(--ai-card-border)] rounded-xl p-6">
              ...
              <h3 className="text-xl font-semibold text-[color:var(--ai-foreground)] mb-3">
                {t('whatWeOffer.projectBased.title')}
              </h3>
            ...
            <div className="bg-[color:var(--ai-card-bg)] border border-[color:var(--ai-card-border)] rounded-xl p-6">
              ...
              <h3 className="text-xl font-semibold text-[color:var(--ai-foreground)] mb-3">
                {t('whatWeOffer.expertInstructors.title')}
              </h3>
              <p className="text-[color:var(--ai-muted)]">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-[color:var(--ai-foreground)] mb-2">
                  {t('values.improvement.title')}
                </h3>
                <p className="text-[color:var(--ai-muted)]">
                  {t('values.improvement.description')}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center bg-gradient-to-r from-[color:var(--ai-primary)]/10 to-[color:var(--ai-secondary)]/10 rounded-xl p-8">
          <h2 className="text-2xl font-bold text-[color:var(--ai-foreground)] mb-4">
            {t('cta.title')}
          </h2>
          <p className="text-[color:var(--ai-muted)] mb-6">{t('cta.description')}</p>
