...
const SortableLesson = ({ lesson, index, handleEditLesson }: { lesson: Lesson, index: number, handleEditLesson: (lesson: Lesson) => void }) => {
    ...
    return (
        <tr ref={setNodeRef} style={style} {...attributes} {...listeners} className="hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <div className="mb-8">
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center">
                        ...
                        {isSaving && (
                            <span className="ml-3 text-sm text-blue-600 dark:text-blue-400 inline-flex items-center">
