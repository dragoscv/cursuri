  ...
  const faqStructuredData = generateFAQStructuredData([
    {
      ...
      answer: 'Yes — on the Copilot plan. The Copilot subscription auto-provisions a personal GitHub account with unlimited GitHub Copilot Pro enabled, with unrestricted access to all the latest frontier models including Claude Opus 4.7, GPT-5, and Gemini 2.5 Pro, plus every new model on day one. The Courses-only plan unlocks every course and lesson but does not include a provisioned Copilot account. After checkout on the Copilot plan you find your credentials in Profile → GitHub on studiai.ro and sign into VS Code (Insiders recommended) to use chat, inline edits, multi-file changes, and agent mode.',
    },
    {
