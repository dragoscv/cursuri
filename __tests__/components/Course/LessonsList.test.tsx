...
const renderWithContext = (
  ...
  contextValue?: Partial<AppContextProps>
) => {
  const fullContext = createMockContext(contextValue);
  return render(<AppContext.Provider value={fullContext}>{component}</AppContext.Provider>);
};
...
describe('LessonsList Component', () => {
  ...
  describe('Lesson Access Control', () => {
    it('should show lock icons for paid lessons when user has no access', () => {
      renderWithContext(
        <LessonsList lessons={mockLessons} course={mockCourse} userHasAccess={false} />
      );
    ...
    it('should show play icons for lessons when user has access', () => {
      renderWithContext(
        <LessonsList lessons={mockLessons} course={mockCourse} userHasAccess={true} />
      );
  ...
  describe('Lesson List Rendering', () => {
    ...
    it('should handle empty lessons array gracefully', () => {
      renderWithContext(<LessonsList lessons={[]} course={mockCourse} userHasAccess={true} />);
